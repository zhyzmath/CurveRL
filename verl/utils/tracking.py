    ...
    def __init__(
        ...
        if "tracking" in default_backend or "wandb" in default_backend:
            ...
            def _resolve_wandb_entity():
                ...
                if config is not None:
                    try:
                        ...
                        trainer_entity = trainer_cfg.get("wandb_entity", None)
                    except Exception:
                        trainer_entity = None

                if trainer_entity:
                    return trainer_entity
                ...
                try:
                    ...
                    if isinstance(teams, list):
                        for team in teams:
                            if isinstance(team, str) and team and team != default_entity:
                                return team
                except Exception:
                    pass
            ...
            if previous_run_id is not None:
                init_kwargs["id"] = previous_run_id
